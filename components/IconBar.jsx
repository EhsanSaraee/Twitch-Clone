...
const IconBar = () => {
   return (
      <section className="p-2 md:p-8">
         {/* Container */}
         <section className="grid sm:grid-cols-3 lg:grid-cols-5 gap-4 border-t border-gray-700 py-8">
            {/* Grid Item */}
            <div className="w-full h-[50px] bg-[#9147ff] flex justify-between items-center px-4 rounded scale-animation">
